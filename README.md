...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-heart-d877
```

A live public deployment of this template is available at [https://floral-heart-d877.templates.workers.dev](https://floral-heart-d877.templates.workers.dev)
